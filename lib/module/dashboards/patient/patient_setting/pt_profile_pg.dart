...
class _PatientProfilePageState extends State<PatientProfilePage> {
  ...
  _callApi() {
    doctorBloc.add(GetPatientByIdEvent(prefs.getString(PreferenceString.prefsUserId).toString()));
  }
        ...
        listener: (context, state) {
          ...
          if (state is LoadedState) {
            ...
            if (patientDetail != null) {
              nameCtrl.text = patientDetail?.patientDetailData?.name ?? "";
              emailCtrl.text = patientDetail?.patientDetailData?.email ?? "";
              phoneCtrl.text = patientDetail?.patientDetailData?.phone ?? "";
            }
          }
        },

...
class TechnicianProfilePage extends StatefulWidget {
  TechnicianProfilePage({super.key});
...
class _TechnicianProfilePageState extends State<TechnicianProfilePage> {
  ...
  GetTechnicianByIdResponse? getTechnicianByIdResponse;
  ...
  _callApi() {
    technicianBloc.add(GetTechnicianByIdEvent(prefs.getString(PreferenceString.prefsUserId).toString()));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<TechnicianBloc, TechnicianState>(
        bloc: technicianBloc,
        listener: (context, state) {
          ...
          if (state is LoadedState) {
            showSpinner = false;
            getTechnicianByIdResponse = state.data;
            if (getTechnicianByIdResponse != null) {
              nameCtrl.text = getTechnicianByIdResponse?.data?.name ?? "";
              emailCtrl.text = getTechnicianByIdResponse?.data?.email ?? "";
              phoneCtrl.text = getTechnicianByIdResponse?.data?.phone ?? "";
            }
          }
        },

...
class TechnicianMedicalReportDialog extends StatelessWidget {
  const TechnicianMedicalReportDialog({super.key});
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Medical Report',
                              style: GoogleFonts.dmSans(fontSize: 16.sp, fontWeight: FontWeight.bold, color: AppColors.gray),
                            ),
                            SizedBox(height: 8),

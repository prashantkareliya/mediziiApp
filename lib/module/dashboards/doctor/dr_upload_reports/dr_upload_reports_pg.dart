...
import '../../patient/patient_home/pt_reposts_upload_pg.dart';

class DoctorReportsUploadPage extends StatefulWidget {
  PatientData? patient;
  DoctorReportsUploadPage(this.patient, {super.key});

  @override
  State<DoctorReportsUploadPage> createState() => _DoctorReportsUploadPageState();
}

class _DoctorReportsUploadPageState extends State<DoctorReportsUploadPage> {

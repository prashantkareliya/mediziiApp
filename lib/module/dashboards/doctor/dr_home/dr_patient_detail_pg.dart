...
class DoctorPatientDetailPg extends StatefulWidget {
  ...
  DoctorPatientDetailPg(this.sId, {super.key});

  @override
  State<DoctorPatientDetailPg> createState() => _DoctorPatientDetailPgState();
}

class _DoctorPatientDetailPgState extends State<DoctorPatientDetailPg> {

...
import 'dr_summery_detail_pg.dart';

class DoctorPatientSummeryPage extends StatefulWidget {
  const DoctorPatientSummeryPage({super.key});

  @override
  State<DoctorPatientSummeryPage> createState() => _DoctorPatientSummeryPageState();
}

class _DoctorPatientSummeryPageState extends State<DoctorPatientSummeryPage> {
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: ListTile(
              onTap: () {
                navigationService.push(DoctorSummeryDetailPg());
              },
